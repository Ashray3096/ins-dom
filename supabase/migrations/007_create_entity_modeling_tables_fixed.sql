...
-- ============================================================================
-- CLEANUP: Drop existing tables if they exist (in correct order for dependencies)
-- ============================================================================

DROP TABLE IF EXISTS entity_relationships CASCADE;
DROP TABLE IF EXISTS entity_field_mappings CASCADE;
...
CREATE TABLE entity_field_mappings (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
