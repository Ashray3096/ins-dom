"""
Auto-generated Dagster pipeline for raw_nabca_table_2
...
@asset(
    name="extract_raw_nabca_table_2",
    description="Extract Current Month Sales data from NABCA PDFs using AWS Textract",
    compute_kind="extraction:textract",
    retry_policy=RetryPolicy(max_retries=3),
)
def extract_raw_nabca_table_2(context: AssetExecutionContext) -> Dict[str, Any]:
    """
    Extract raw_nabca_table_2 data from NABCA PDF artifacts.

    NABCA Section: Current Month Sales
    Page Range: 5-6
    Extraction Method: AWS Textract (Table Detection)
    Entity Type: INTERIM
    """
    try:
        context.log.info(f"Starting NABCA extraction for raw_nabca_table_2")
        context.log.info(f"Section: Current Month Sales, Pages: 5-6")
        ...
        semantic_fields = [{"name":"class","displayName":"class","dataType":"TEXT"},{"name":"pct_total_dist_spirits","displayName":"pct_total_dist_spirits","dataType":"NUMBER"},{"name":"pct_of_class","displayName":"pct_of_class","dataType":"NUMBER"},{"name":"total_cases","displayName":"total_cases","dataType":"NUMBER"},{"name":"bottle_1_75l","displayName":"bottle_1_75l","dataType":"NUMBER"},{"name":"bottle_1_0l","displayName":"bottle_1_0l","dataType":"NUMBER"},{"name":"bottle_750ml","displayName":"bottle_750ml","dataType":"NUMBER"},{"name":"bottle_750ml_traveler","displayName":"bottle_750ml_traveler","dataType":"NUMBER"},{"name":"bottle_375ml","displayName":"bottle_375ml","dataType":"NUMBER"},{"name":"bottle_200ml","displayName":"bottle_200ml","dataType":"NUMBER"},{"name":"bottle_100ml","displayName":"bottle_100ml","dataType":"NUMBER"},{"name":"bottle_50ml","displayName":"bottle_50ml","dataType":"NUMBER"}]
        ...
        for artifact in artifacts:
            try:
                ...
                # Extract specific page range (5-6)
                context.log.info(f"Extracting pages 5-6...")
        ...
        return {
            ...
            "metadata": {
                ...
                "nabca_section": "Current Month Sales",
                "page_range": "5-6",
            }
        }
...
@asset(
    name="load_raw_nabca_table_2",
    description="Load transformed data into raw_nabca_table_2 table",
    compute_kind="load",
    deps=["extract_raw_nabca_table_2"],
    retry_policy=RetryPolicy(max_retries=3),
)
def load_raw_nabca_table_2(
    context: AssetExecutionContext,
    extract_raw_nabca_table_2: Dict[str, Any]
) -> MaterializeResult:
    """
    Load raw_nabca_table_2 data into database.

    Target Table: raw_nabca_table_2
    Entity Type: INTERIM
    """
    try:
        context.log.info(f"Starting load for raw_nabca_table_2")
        ...
        records = extract_raw_nabca_table_2["records"]
        ...
        for i in range(0, len(clean_records), batch_size):
            ...
            try:
                response = supabase.table("raw_nabca_table_2").insert(batch).execute()
                ...
                for record in batch:
                    try:
                        supabase.table("raw_nabca_table_2").insert(record).execute()
                        loaded_count += 1
        ...
        return MaterializeResult(
            metadata={
                ...
                "table_name": MetadataValue.text("raw_nabca_table_2"),
            }
        )
